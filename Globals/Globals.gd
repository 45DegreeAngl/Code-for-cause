...
#@onready var pedestrian_array:Array = [preload("res://Scenes/Inheritance/Ped/GabePed.tscn")]
...
#@onready var cop_array:Array = [preload("res://Scenes/Inheritance/Cop/GabeCop.tscn")]
